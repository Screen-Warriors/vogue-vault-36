      ...
      <div className="mt-12 grid lg:grid-cols-3 gap-10">
          ...
          {items.length > 0 ? (
                ...
                <div className="flex-1 min-w-0 flex flex-col">
                  ...
                  <div className="mt-auto flex items-end justify-between">
                    <div className="flex items-center hairline rounded-full">
                      <button
                        onClick={() => updateQuantity(item.key, Math.max(1, item.qty - 1))}
            ...
            <div className="glass rounded-sm p-12 text-center">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Add an item from the product page to see it here.
              </p>
            </div>
          )}
        </div>
        ...
        <aside className="lg:sticky lg:top-28 self-start glass-strong rounded-sm p-6 md:p-8 space-y-6">
          ...
          <div className="flex gap-2 hairline rounded-full p-1">
            ...
            />
            <button className="px-4 py-2 text-xs uppercase tracking-[0.24em] bg-foreground text-background rounded-full">
              Apply
            </button>
          </div>
          ...
          <Link
            to="/checkout"
            className="w-full bg-foreground text-background py-4 text-xs uppercase tracking-[0.24em] hover:bg-accent hover:text-accent-foreground transition-colors flex items-center justify-center gap-3"
          >
